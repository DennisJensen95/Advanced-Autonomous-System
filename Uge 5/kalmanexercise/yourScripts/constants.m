...
kR = 0.0001;%(0.005)^2;  % The variance of the linear uncertainty for a 1m move for the right wheel
kL = 0.0001;%(0.005)^2;  % The variance of the linear uncertainty for a 1m move for the left wheel
smrNo=0
